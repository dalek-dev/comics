...
import 'package:marvel_app/src/events/view_models/events_view_model.dart';
...
class EventsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => EventsViewModel()..fetchMarvelEvent(arguments.id ?? 0),
      child: Scaffold(
        body: Stack(
          children: [
            Container(
                        ...
                        return Padding(
                          ...
                          child: SingleChildScrollView(
                              ...
                              child: Wrap(
                                  ...
                                  children: List.generate(model.events.length,
                                      (index) {
                                    return Container(
                                      ...
                                      child: ComicPhoto(
                                          ...
                                          thumbnail: Thumbnail(
                                              extension: model.events[index]
                                                      .thumbnail?.extension ??
                                                  '',
                                              path: model.events[index]
                                                      .thumbnail?.path ??
                                                  '')),
                                    );
                                  }))),
